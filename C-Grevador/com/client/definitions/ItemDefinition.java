...
public final class ItemDefinition {
	...
	private static void customItems(int itemId) {
		...
		itemDef.anInt204 = 0;
		itemDef.maleModel = 42627;
		itemDef.femaleModel = 42642;
		itemDef.description = "Zuriel's Robe Top, a reward from PVP.";
	break;
			case 22616:
			itemDef.modelId = 35987;
		...
		itemDef.anInt204 = 0;
		itemDef.maleModel = 42634;
		itemDef.femaleModel = 42645;
	...
	break; 
		...
		itemDef.modelOffset1 = 1;
		itemDef.anInt204 = 0;
		itemDef.maleModel = 42638;
		itemDef.femaleModel = 42653;
...
*/
	case 13887:
		...
		itemDef.modelOffset1 = 4;
		itemDef.anInt204 = 0;
		itemDef.maleModel = 42624;
		itemDef.femaleModel = 42644;
	...
	case 13893:
		...
		itemDef.modelOffset1 = -3;
		itemDef.anInt204 = 0;
		itemDef.maleModel = 42633;
		itemDef.femaleModel = 42649;
	...
	break;
		...
		case 1464:
			...
			break;
	/*	case 22550:
			itemDef.modelId = 35777; // Drop/Inv Model
			itemDef.maleModel = 35768; // Drop/Inv Model
			itemDef.femaleModel = 35768; // Drop/Inv Model
	...
	/*	case 20514:
			...
			break;*/
			case 20515:
			itemDef.modelId = 35775; // Drop/Inv Model
			itemDef.maleModel = 35769; // Drop/Inv Model
			itemDef.femaleModel = 35769; // Drop/Inv Model
			itemDef.modelZoom = 2128;
			itemDef.modelRotation2 = 552;
			itemDef.modelRotation1 = 1508;
			itemDef.stackable = false;
			itemDef.name = "Craw's bow (i)"; // Item Name
			itemDef.description = "Craw's bow (i)"; // Item
			itemDef.equipActions = new String[5];
			itemDef.equipActions[1] = "Wield";
				    itemDef.aByte205 = -10;
				    itemDef.aByte154 = -10;
			...
			itemDef.stackable = false;
			itemDef.name = "Craw's bow (broken)"; // Item Name
			itemDef.description = "This item needs to be fixed."; // Item
			itemDef.anInt196 = -50;
			break;
		/*	case 20517:
			ItemDef.modelID = 35776; // Drop/Inv Model
			ItemDef.maleEquip1 = 35772; // Drop/Inv Model
			ItemDef.femaleEquip1 = 35772; // Drop/Inv Model
			ItemDef.modelZoom = 2857;
			ItemDef.modelRotation1 = 567;

			ItemDef.modelRotation2 = 2031;

			ItemDef.stackable = false;
			ItemDef.name = "Thammaron's sceptre"; // Item Name
			ItemDef.description = "Thammaron's sceptre"; // Item
			ItemDef.actions = new String[5];
			...
			break;
			case 20518:
			ItemDef.modelID = 35774; // Drop/Inv Model
			ItemDef.maleEquip1 = 35773; // Drop/Inv Model
			ItemDef.femaleEquip1 = 35773; // Drop/Inv Model
			ItemDef.modelZoom = 2857;
			ItemDef.modelRotation1 = 567;
			...
			ItemDef.stackable = false;
			ItemDef.name = "Thammaron's sceptre (i)"; // Item Name
			ItemDef.description = "Thammaron's sceptre (i)"; // Item
			ItemDef.actions = new String[5];
			ItemDef.actions[1] = "Wield";
				    ItemDef.aByte205 = -10;
				    ItemDef.aByte154 = -10;
			...
			ItemDef.stackable = false;
			ItemDef.name = "Thammaron's sceptre (broken)"; // Item Name
			ItemDef.description = "This item needs to be fixed."; // Item
			ItemDef.anInt196 = -50;
			break;
			case 20520:
			ItemDef.actions = new String[5];
			ItemDef.actions[1] = "Wield";
			ItemDef.modelID = 35778; // Drop/Inv Model
			ItemDef.maleEquip1 = 35770;
			ItemDef.femaleEquip1 = 35770;
			ItemDef.modelZoom = 1964;
			ItemDef.modelRotation1 = 567;

			ItemDef.modelRotation2 = 2031;

			ItemDef.stackable = false;
			ItemDef.name = "Viggora's chainmace"; // Item Name
			ItemDef.description = "Viggora's chainmace"; // Item
				    ItemDef.aByte205 = -10;
				    ItemDef.aByte154 = -10;
			break;
			case 20521:
			ItemDef.actions = new String[5];
			ItemDef.actions[1] = "Wield";
			ItemDef.modelID = 35780; // Drop/Inv Model
			ItemDef.maleEquip1 = 35771;
			ItemDef.femaleEquip1 = 35771;
			ItemDef.modelZoom = 1964;
			ItemDef.modelRotation1 = 567;
			...
			ItemDef.stackable = false;
			ItemDef.name = "Viggora's chainmace (i)"; // Item Name
			ItemDef.description = "Viggora's chainmace (i)"; // Item
				    ItemDef.aByte205 = -10;
				    ItemDef.aByte154 = -10;
			break;
			case 20522:
			...
			ItemDef.stackable = false;
			ItemDef.name = "Viggora's chainmace (broken)"; // Item Name
			ItemDef.description = "This item needs to be fixed."; // Item
			ItemDef.anInt196 = -50;
			break; */
		}
	...
	private void readValues(Stream stream) {
		while (true) {
			...
			if (opcode == 0) {
				...
				for (int i = 0; i < len; i++) {
					originalModelColors[i] = stream.readUnsignedWord();
					modifiedModelColors[i] = stream.readUnsignedWord();
				}
			} else if (opcode == 41) {
				int len = stream.readUnsignedByte();
				originalTextureColors = new short[len];
				modifiedTextureColors = new short[len];
				for (int i = 0; i < len; i++) {
					originalTextureColors[i] = (short) stream.readUnsignedWord();
					modifiedTextureColors[i] = (short) stream.readUnsignedWord();
				}
			/*} else if (opcode == 42) {
