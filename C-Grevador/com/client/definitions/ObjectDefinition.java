...
public final class ObjectDefinition {
	...
	public static ObjectDefinition forID(int i) {
		...
		case 22819:
			objectDef.actions[0] = "Bank";
			objectDef.actions[1] = "Grand Exchange";
			break;
		case 1761:
			objectDef.modelIds = new int[] { 12926, };
			objectDef.name = "Magic";
			objectDef.width = 2;
			objectDef.length = 2;
	 ...
	 * scaleX = stream.readUnsignedWord(); else if (j == 66) height =
		...
		//while(true) {
			...
			if (opcode == 0) 
			 ...
			 if (opcode == 1) {
				...
				translateY = stream.readUnsignedWord();
			} else if (opcode == 72) {
				translateZ = stream.readUnsignedWord();
			} else if (opcode == 73) {
