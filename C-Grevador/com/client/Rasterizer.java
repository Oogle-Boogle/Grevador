...
public final class Rasterizer extends DrawingArea {
    ...
    static final int[] anIntArray1469;
    ...
    static int[] hslToRgb = new int[0x10000];
    ...
    private static boolean enableMipmapping = true;
    ...
    static int getOverallColour(int textureId) {
    ...
    private static boolean enableHDTextures = false;

    static void drawMaterializedTriangle(int y1, int y2, int y3, int x1, int x2, int x3, int hsl1, int hsl2,
    ...
    private static void drawMaterializedScanline(int[] dest, int[] texels, int offset, int x1, int x2, int hsl1,
    ...
    static void drawGouraudTriangle(int y1, int y2, int y3, int x1, int x2, int x3, int hsl1, int hsl2, int hsl3,
    ...
    private static void drawLDGouraudTriangle(int y1, int y2, int y3, int x1, int x2, int x3, int hsl1, int hsl2,
    ...
    private static void drawHDGouraudTriangle(int y1, int y2, int y3, int x1, int x2, int x3, int hsl1, int hsl2,
                                              int hsl3, float z1, float z2, float z3) {
        if (!saveDepth) {
            z1 = z2 = z3 = 0;
        }
    ...
    private static void drawHDGouraudScanline(int[] dest, int offset, int x1, int x2, int r1, int g1, int b1, int r2,
    ...
    static void drawFlatTriangle(int y1, int y2, int y3, int x1, int x2, int x3, int rgb, float z1, float z2,
                                 float z3) {
        if (!saveDepth) {
            z1 = z2 = z3 = 0;
        }
    ...
    private static void drawTexturedTriangle317(int y1, int y2, int y3, int x1, int x2, int x3, int c1, int c2, int c3,
    ...
    static void drawTexturedTriangle(int y1, int y2, int y3, int x1, int x2, int x3, int c1, int c2, int c3,
