...
public class RSInterface {
	...
	public boolean showExamine = true;
	...
	protected static void hoverButton(int id, String tooltip, int sprite2, int sprite1) {
		hoverButton(id, tooltip, sprite2, sprite1, 255);
	}

	protected static void configButton(int id, String tooltip, int enabledSprite, int disabledSprite) {
	...
	private static void hoverButton(int id, String tooltip, int opacity) {
		RSInterface tab = addInterface(id);
		tab.tooltip = tooltip;
		tab.atActionType = 1;
		tab.type = TYPE_HOVER;
	...
	private static void hoverButton(int id, String tooltip, int sprite2, int sprite1, int opacity) {
		RSInterface tab = addInterface(id);
		tab.tooltip = tooltip;
		tab.atActionType = 1;
		tab.type = TYPE_HOVER;
	...
	protected static void hoverButton(int id, String tooltip, int enabledSprite, int disabledSprite, String buttonText,
	...
	protected static void dropdownMenu(int id, int width, int defaultOption, String[] options, Dropdown d,
	...
	private static void dropdownMenu(int id, int width, int defaultOption, String[] options, Dropdown d,
	...
	private static void configHoverButtonSwitch(RSInterface widget) {
	...
	private static void disableOtherButtons(RSInterface widget) {
	...
	private static void skillMenu(TextDrawingArea[] tda) {
		RSInterface tab = addInterface(8000);
		
		addSprite(8001, 1, "Interfaces/skillMenu/BACKGROUND"); //Background
		
		addText(8002, "Necromancy", tda, 2, 0xff9040, true, true); //Necromancy Text
		
		addHoverButton(8003, "", 1, 34, 24, "Summon", -1, 8004, 1); //Middle Button
		addHoveredButton(8004, "", 1, 34, 24, 8005); //Middle Button
		
		setChildren(4, tab);
		setBounds(8001, 5, 5, 0, tab);
		setBounds(8002, 145, 15, 1, tab);
		setBounds(8003, 131, 138, 2, tab);
		setBounds(8004, 131, 138, 3, tab);
	...
	//sec
	private static void achievementPopup2(TextDrawingArea[] tda) {
	...
	protected static void questTab(TextDrawingArea[] tda) {
		...
		addText(10222, "@or1@Grevador", tda, 2, 16750899, true, true);
		...
		try
		{
			...
			addText(29474, "@or1@Total diary's: @gre@11", tda, 2, 16750899, true, true);
	...
	private static void itemGroup(int id, int w, int h, int x, int y, boolean drag, boolean examine) {
	...
	protected static TextDrawingArea[] defaultTextDrawingAreas;
...
public static void NpcKillCount(TextDrawingArea[] tda) {
	RSInterface tab = addInterface(49500);
	String dir = "Interfaces/DropViewer/SPRITE";
	addSprite(49501, 0, dir);
	addHoverButton(49502, dir, 1, 21, 21, "Close", 0, 49503, 1);
	addHoveredButton(49503, dir, 2, 21, 21, 49504);
	addText(49504, "Npc Kill Count:", tda, 2, 0xFFA500, true, true);
	addText(49506, "Npc Kills:", tda, 2, 0xFFA500, true, true);
	addText(49507, "Click the box for a ultra mystery box!", tda, 2, 0xFFA500, true, true);
	addButton(49508, 6, dir, "Claim your reward!");
	addText(49509, "Your Most Recent kill:", tda, 2, 0xFFA500, true, true);
	addText(49510, "Number of Kills:", tda, 2, 0xFFA500, true, true);
	addText(49511, "test", tda, 2, 0xFFA500, true, true);
	addText(49512, "test1", tda, 2, 0xFFA500, true, true);
	//addChar(49513);
	//addPet(49513);
	addNpc(49513, 50);
	int x = 7, y = 7;
	setChildren(13, tab);
	setBounds(49501, 7, 7, 0, tab);
	setBounds(49502, 479, 14, 1, tab);
	setBounds(49503, 479, 14, 2, tab);
	setBounds(49504, 300, 18, 3, tab);
	setBounds(49505, 6 + x, 66 + y, 4, tab);
	setBounds(49506, 85 + x, 37 + y, 5, tab);
	setBounds(49507, 325, 58, 6, tab);
	setBounds(49508, 460, 58, 7, tab);
	setBounds(49509, 360, 119, 8, tab);
	setBounds(49510, 360, 240, 9, tab);
	setBounds(49511, 360, 146, 10, tab);
	setBounds(49512, 360, 267, 11, tab);
	setBounds(49513, 190, 200, 12, tab);

	RSInterface Scroll = addInterface(49505); // results
	Scroll.width = 150;
	Scroll.height = 225;
	Scroll.scrollMax = 1500;
	Scroll.totalChildren(52);
	for (int j = 0; j < 52; j++) {
		addText(43008 + j, " ", tda, 2, 0xFFA500, true, true);
		Scroll.child(j, 43008 + j, 70, 15 + (j * 14));
	}
	...
	private static void addHoverButton_sprite_loader2(int i, int spriteId, int width, int height, String text,
	...
	private static void addHoveredButton_sprite_loader2(int i, int spriteId, int w, int h, int IMAGEID) {// hoverable
		// button
		RSInterface tab = addTabInterface(i);
		tab.parentID = i;
		tab.id = i;
	...
	private static void addHoverImage_sprite_loader2(int i, int spriteId) {
		RSInterface tab = addTabInterface(i);
		tab.id = i;
		tab.parentID = i;
		tab.type = 5;
	...
	protected static void quickPrayers(TextDrawingArea[] TDA) {
		int frame = 0;
	...
	private static void addPrayer(final int i, final int configId, final int configFrame, final int requiredValues,
	...
	protected static void spawnTab(TextDrawingArea[] tda) {
	...
	protected static void teleportationInterface(TextDrawingArea[] tda) {
	...
	protected static void addAntibotWidget(TextDrawingArea[] tda) {
	...
	protected static void addModerateWidget(TextDrawingArea[] tda) {
	...
	protected static void addPestControlRewardWidget(TextDrawingArea[] tda) {
	...
	protected static void lootingBagAdd(TextDrawingArea[] tda) {
	...
	protected static void lootingBag(TextDrawingArea[] tda) {
	...
	private static void addItem(int childId, String[] options) {
	...
	private static void addItem(int childId, String[] options, int interfaceId) {
    ...
    protected static void initializeTitleWidget(TextDrawingArea[] tda) {
	...
	protected static final void initializeCommandHelp() {
	...
	protected static void preloadEquipmentWidget(TextDrawingArea[] tda) {
	...
	private static void addSpawnChooser(int interfaceId, TextDrawingArea[] tda) {
	...
	protected static void updateShopWidget(TextDrawingArea[] tda) {
	...
	protected static void shopWidget(TextDrawingArea[] tda) {
	...
	protected static void bountyHunterWidget(TextDrawingArea[] tda) {
	...
	protected static void PVPInterface(TextDrawingArea[] tda) {
	...
	protected static void PVPInterface2(TextDrawingArea[] tda) {
	...
	protected static void PVPInterface3(TextDrawingArea[] tda) {
	...
	protected static void helpComponent(TextDrawingArea[] tda) {
	...
	protected static void barrowsReward(TextDrawingArea[] wid) {
	...
	protected static void staffInterface(TextDrawingArea[] wid) {
		RSInterface tab = addInterface(36000);
	...
	protected static void staffInterfaceBank(TextDrawingArea[] wid) {
	...
	protected static void wellOfGoodWill(TextDrawingArea[] tda) {
	...
	protected static void safeBox(TextDrawingArea[] wid) {
	...
	protected static void bankPin(TextDrawingArea[] wid) {
	...
	private static RSInterface addFullScreenInterface(int id) {
	...
	private static void addBankHover(int interfaceID, int actionType, int hoverid, int spriteId, int spriteId2,
	...
	private static void addConfigButton(int ID, int pID, int bID, int bID2, String bName, int width, int height,
	...
	protected static void addButton(int i, int j, String name, int W, int H, String S, int AT) {
	...
	private static void addButton(int interfaceId, int spriteId, String spriteLocation, int width, int height,
								  String[] tooltips) {
	...
	private static void addBankHover1(int interfaceID, int actionType, int hoverid, int spriteId, String NAME, int Width,
	...
	protected static void itemsKeptOnDeath(TextDrawingArea[] tda) {
	...
	protected static void addTextButton(int i, String s, String tooltip, int k, boolean l, boolean m,
	...
	protected static void homeTeleport() {
	...
	private static void addLunarSprite(int i, int j, String name) {
		RSInterface RSInterface = addInterface(i);
		RSInterface.id = i;
		RSInterface.parentID = i;
		RSInterface.type = 5;
	...
	protected static void drawRune(int i, int id, String runeName) {
		RSInterface RSInterface = addInterface(i);
		RSInterface.type = 5;
		RSInterface.atActionType = 0;
		RSInterface.contentType = 0;
	...
	protected static void addLunar3RunesSmallBox(int ID, int r1, int r2, int r3, int ra1, int ra2, int ra3, int rune1,
	...
	protected static void addSpellSmall2(int ID, int r1, int r2, int r3, int ra1, int ra2, int ra3, int rune1,
	...
	protected static void addSpellSmall(int ID, int r1, int r2, int r3, int ra1, int ra2, int ra3, int rune1,
										int rune2, int rune3, int lvl, String name, String descr, TextDrawingArea[] TDA, int sid, int suo, int type) {
		RSInterface rsInterface = addInterface(ID);
		rsInterface.id = ID;
		rsInterface.parentID = 1151;
	...
	protected static void addSpellSmaller(int ID, int r1, int r2, int ra1, int ra2, int rune1,
										  int rune2, int lvl, String name, String descr, TextDrawingArea[] TDA, int sid, int suo, int type) {
		RSInterface rsInterface = addInterface(ID);
		rsInterface.id = ID;
		rsInterface.parentID = 1151;
	...
	protected static void addLunar2RunesSmallBox(int ID, int r1, int r2, int ra1, int ra2, int rune1, int lvl, String name,
	...
	protected static void addLunar3RunesBigBox(int ID, int r1, int r2, int r3, int ra1, int ra2, int ra3, int rune1,
											   int rune2, int lvl, String name, String descr, TextDrawingArea[] TDA, int sid, int suo, int type) {
		RSInterface rsInterface = addInterface(ID);
		rsInterface.id = ID;
		rsInterface.parentID = 1151;
	...
	protected static void addSpellBig2(int ID, int r1, int r2, int r3, int ra1, int ra2, int ra3, int rune1,
									   int rune2, int rune3, int lvl, String name, String descr, TextDrawingArea[] TDA, int sid, int suo, int type) {
		RSInterface rsInterface = addInterface(ID);
		rsInterface.id = ID;
		rsInterface.parentID = 1151;
	...
	protected static void addSettingsSprite(int childId, int spriteId) {
		RSInterface rsi = interfaceCache[childId] = new RSInterface();
		rsi.id = childId;
	...
	protected static void configHoverButton(int id, String tooltip, int sprite2, int sprite1, int enabledAltSprite,
	...
	protected static void addLunar3RunesLargeBox(int ID, int r1, int r2, int r3, int ra1, int ra2, int ra3, int rune1,
												 int rune2, int lvl, String name, String descr, TextDrawingArea[] TDA, int sid, int suo, int type) {
		RSInterface rsInterface = addInterface(ID);
		rsInterface.id = ID;
		rsInterface.parentID = 1151;
	...
	protected static void addSpellSmall2_3(int ID, int r1, int r2, int r3, int r4, int ra1, int ra2, int ra3, int ra4, int rune1,
	...
	protected static void addSpellLarge2(int ID, int r1, int r2, int r3, int ra1, int ra2, int ra3, int rune1,
										 int rune2, int rune3, int lvl, String name, String descr, TextDrawingArea[] TDA, int sid, int suo, int type) {
		RSInterface rsInterface = addInterface(ID);
		rsInterface.id = ID;
		rsInterface.parentID = 1151;
	...
	protected static void addText(int id, String text, TextDrawingArea wid[], int idx, int color) {
	...
	private static void addHoverText(int id, String text, String tooltip, TextDrawingArea tda[], int idx, int color,
	...
	protected static RSInterface addTab(int i) {
	...
	protected static void addConfigButton(int ID, int pID, int bID, int bID2, String bName, int width, int height,
	...
	protected static void addPrayer(int i, int configId, int configFrame, int requiredValues, int spriteID,
									String prayerName) {
		RSInterface tab = addTabInterface(i);
		tab.id = i;
		tab.parentID = 5608;
	...
	protected static void removeSomething(int id) {
	...
	protected static void textSize(int id, TextDrawingArea tda[], int idx) {
	...
	protected static void addChar(int ID) {
	...
	private static void addBox(int id, int byte1, boolean filled, int color, String text) {
	...
	protected static void setChildren(int total, RSInterface i) {
	...
	protected static void addText(int i, String s, int k, boolean l, boolean m, int a, TextDrawingArea[] TDA, int j) {
		RSInterface RSInterface = addInterface(i);
		RSInterface.parentID = i;
		RSInterface.id = i;
		RSInterface.type = 4;
	...
	protected static void addSprite(int i, int j, int k) {
		RSInterface rsinterface = interfaceCache[i] = new RSInterface();
		rsinterface.id = i;
		rsinterface.parentID = i;
		rsinterface.type = 5;
	...
	protected static void addHovered(int i, int j, String imageName, int w, int h, int IMAGEID) {
		RSInterface rsinterfaceHover = addInterface(i);
		rsinterfaceHover.parentID = i;
		rsinterfaceHover.id = i;
	...
	protected static void addText(int id, String text, TextDrawingArea tda[], int idx, int color, boolean center,
								  boolean shadow) {
		RSInterface tab = addTabInterface(id);
		tab.parentID = id;
		tab.id = id;
	...
	protected static void addButton(int id, int sid, String spriteName, String tooltip) {
		RSInterface tab = interfaceCache[id] = new RSInterface();
		tab.id = id;
		tab.parentID = id;
		tab.type = 5;
	...
	private static void addButton(int id, int spriteId, String spriteName, String tooltip, int actionType,
	...
	private static void addSprite(int ID, int i, int i2, String name, int configId, int configFrame) {
		RSInterface Tab = addTabInterface(ID);
		Tab.id = ID;
		Tab.parentID = ID;
		Tab.type = 5;
	...
	protected static void addSprite(int id, int spriteId, String spriteName) {
		RSInterface tab = interfaceCache[id] = new RSInterface();
		tab.id = id;
		tab.parentID = id;
		tab.type = 5;
	...
	private static void addHoverImage(int i, int j, int k, String name) {
		RSInterface tab = addTabInterface(i);
		tab.id = i;
		tab.parentID = i;
		tab.type = 5;
	...
	protected static void addProgressBar(int identity, int width, int height, int[] colorTypes) {
	...
	private static void darken(int identity, int width, int height, int color, byte transparency) {
		RSInterface component = addInterface(identity);
		component.id = identity;
		component.type = 17;
		component.width = width;
	...
	private static void drawRoundedRectangle(int identity, int width, int height, int color, byte transparency,
	...
	protected static void addSprites(int id, String path, int... spriteIds) {
	...
	protected static void addClickableSprites(int id, String tooltip, String path, int... spriteIds) {
