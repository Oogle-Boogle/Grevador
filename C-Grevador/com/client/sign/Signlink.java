...
public final class Signlink implements Runnable {
	...
	private final static String CACHE_NAME = ".Grevador";
	...
	static {
		File file = new File(System.getProperty("user.home") + "/" + CACHE_NAME + "/");
		if (!file.exists()) {
			file.mkdir();
		}
		file = new File(System.getProperty("user.home") + "/" + CACHE_NAME + "/");
		if (!file.exists()) {
			file.mkdir();
		}
	}
